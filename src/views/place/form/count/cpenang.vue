...
<script>
import gth from '../../../../assets/penang1.jpg'
import pnp from '../../../../assets/penang2.jpg'
import phf from '../../../../assets/penang3.jpg'
import psf from '../../../../assets/penang4.jpg'

export default {
  name: 'TripCalculatorPenang',
  ...
  data() {
    return {
      ...
      attractions: [
        {
          id: 1,
          name: 'George Town Heritage & Street Art',
          description: 'UNESCO historic city center',
          type: 'Cultural',
          price: 10,
          location: 'Penang',
          city: 'George Town',
        ...
        },
        {
          ...
          description: 'Protected natural park with beaches and trails',
          type: 'Natural',
          price: 5,
          location: 'Penang',
          city: 'Teluk Bahang',
        ...
        },
        {
          ...
          description: 'Scenic hill with panoramic views',
          type: 'Entertainment',
          price: 60,
          location: 'Penang',
          city: 'Penang Hill',
        ...
        },
        {
          ...
          description: 'Famous local food scene',
          type: 'Food',
          price: 12,
          location: 'Penang',
          city: '	George Town',
