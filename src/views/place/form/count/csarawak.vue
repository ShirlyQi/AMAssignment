...
<script>
import bnp from '../../../../assets/sarawak1.jpg'
import mnp from '../../../../assets/sarawak2.jpg'
import kw from '../../../../assets/sarawak3.jpg'
import sl from '../../../../assets/sarawak4.jpg'

export default {
  name: 'TripCalculatorSarawak',
      ...
      attractions: [
        {
          ...
          description: 'National park with wildlife and rainforest',
          type: 'Natural',
          price: 40,
          location: 'Sarawak',
          city: 'Kuching',
        ...
        },
        {
          ...
          description: 'UNESCO site with limestone caves',
          type: 'Natural',
          price: 70,
          location: 'Sarawak',
          city: 'Mulu',
        ...
        {
          id: 3,
          name: 'Kuching Waterfront & Heritage',
          description: 'Scenic historical waterfront area',
          type: 'Cultural',
          price: 10,
          location: 'Sarawak',
          city: 'Kuching',
        ...
        {
          id: 4,
          name: 'Sarawak Laksa & Kolo Mee',
          description: 'Iconic local food dishes',
          type: 'Food',
          price: 13,
          location: 'Sarawak',
          city: 'Kuching',
