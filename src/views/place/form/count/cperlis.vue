...
<script>
import wbc from '../../../../assets/perlis1.jpg'
import pcv from '../../../../assets/perlis2.jpg'
import plf from '../../../../assets/perlis3.png'
import snake from '../../../../assets/perlis4.jpg'

export default {
  name: 'TripCalculatorPerlis',
  ...
  data() {
    return {
      ...
      attractions: [
        {
          id: 1,
          name: 'Wang Burma Cave',
          description: 'Limestone cave and spelunking site',
          type: 'Natural',
          price: 90,
          location: 'Perlis',
          city: 'Kangar',
        ...
        {
          id: 2,
          name: 'Perlis Cultural Village',
          description: 'Cultural representation of Perlis heritage',
          type: 'Cultural',
          price: 2,
          location: 'Perlis',
          city: 'Kangar',
        ...
        {
          id: 3,
          name: 'Perlis Local Food',
          description: 'Local delicacies (seafood & Malay dishes)',
          type: 'Food',
          price: 10,
          location: 'Perlis',
          city: 'Kuala Perlis',
        ...
        {
          id: 4,
          name: 'Snake & Reptile Farm',
          description: 'Wildlife and reptile exhibits',
          type: 'Entertainment	',
          price: 30,
          location: 'Perlis',
          city: 'Beseri',
